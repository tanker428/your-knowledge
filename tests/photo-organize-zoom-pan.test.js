...
describe("Photo organize zoom and pan UI", () => {
  ...
  it("calculates and applies a clipped rotated lens from the highest-resolution image source", () => {
    const dom = new JSDOM(`
    ...
    expect(geometry).toMatchObject({ size: 200, left: 300, top: 100, imageWidth: 400, imageHeight: 800 });
    applyMagnifierGeometry({
    ...
    expect(document.querySelector("#lens")?.style.left).toBe("300px");
